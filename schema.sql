...
DO $$ BEGIN CREATE DOMAIN USER_TOTAL_POINTS INT;
EXCEPTION WHEN DUPLICATE_OBJECT THEN NULL; END $$;
...
DO $$ BEGIN CREATE DOMAIN CONVERSATION_SINGLE_POINTS INT CHECK (VALUE >= 0);
EXCEPTION WHEN DUPLICATE_OBJECT THEN NULL; END $$;
...
CREATE TABLE IF NOT EXISTS users (
	...
	points USER_TOTAL_POINTS NOT NULL DEFAULT 0,
...
CREATE TABLE IF NOT EXISTS conversations (
	...
	upvotes CONVERSATION_SINGLE_POINTS NOT NULL DEFAULT 0,
	downvotes CONVERSATION_SINGLE_POINTS NOT NULL DEFAULT 0,
...
CREATE TABLE IF NOT EXISTS conversation_points (
	conversation_id CONVERSATION_ID NOT NULL REFERENCES conversations(id) ON DELETE CASCADE,
	user_id USER_ID NOT NULL REFERENCES users(id) ON DELETE CASCADE,
	upvote BOOLEAN NOT NULL, -- true for upvote, false for downvote
	created TIMESTAMPTZ NOT NULL DEFAULT NOW(),
