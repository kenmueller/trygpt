...
DO $$ BEGIN CREATE DOMAIN SUBSCRIPTION_ITEM_ID TEXT;
EXCEPTION WHEN DUPLICATE_OBJECT THEN NULL; END $$;
...
DO $$ BEGIN CREATE DOMAIN SUBSCRIPTION_STATUS TEXT CHECK (LENGTH(VALUE) > 0);
EXCEPTION WHEN DUPLICATE_OBJECT THEN NULL; END $$;
...
CREATE TABLE IF NOT EXISTS users (
	...
	tokens USER_TOKENS NOT NULL DEFAULT 0,
	purchased_tokens USER_TOKENS NOT NULL DEFAULT 0,
