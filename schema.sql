...
DO $$ BEGIN CREATE DOMAIN USER_TOTAL_TOKENS INT CHECK (VALUE >= 0);
EXCEPTION WHEN DUPLICATE_OBJECT THEN NULL; END $$;

DO $$ BEGIN CREATE DOMAIN USER_PURCHASED_TOKENS INT CHECK (VALUE >= 0);
EXCEPTION WHEN DUPLICATE_OBJECT THEN NULL; END $$;
...
CREATE TABLE IF NOT EXISTS users (
	...
	total_tokens USER_TOTAL_TOKENS NOT NULL DEFAULT 0,
	purchased_tokens USER_PURCHASED_TOKENS NOT NULL DEFAULT 0,
