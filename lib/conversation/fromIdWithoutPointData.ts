...
const conversationFromIdWithoutPointData = cache(
	(id: string, connection?: DatabasePoolConnection) =>
		connection
			? conversationFromIdWithoutPointDataWithConnection(id, connection)
			: connect(connection =>
					conversationFromIdWithoutPointDataWithConnection(id, connection)
			  )
)

const conversationFromIdWithoutPointDataWithConnection = async (
	id: string,
...
export default conversationFromIdWithoutPointData
